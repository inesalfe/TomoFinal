function save_sparse_ct_gaussian_huge(N_pixels,theta,p,d,seed,eta)
    ...
    fileID = fopen('ct_gaussian/params_sparse_huge.txt','a+');
    ...
    fileID_error = fopen('ct_gaussian/params_sparse_huge.txt','a+');
