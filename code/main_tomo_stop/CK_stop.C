...
// ./bin/CK_stop.exe ct_gaussian 10 19558 16384 7 2

int main (int argc, char *argv[]) {

	if(argc != 6 && argc != 7) {
		cout << "Incorrect number of arguments: Corret usage is ";
		cout << "'./bin/CK_stop.exe <data_set> <n_runs> <M> <N> <bucket_size>'" << endl;
		exit(1);
	}
	...
	string filename_sol = "outputs/tomo_stop/" + matrix_type + "/CK_sol_" + to_string(M) + "_" + to_string(N);
