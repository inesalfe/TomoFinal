...
// ./bin/CK_twin_box_proj_max_it_alpha_data.exe ct_gaussian 10 19558 16384 0.15 10000000 1 2
// ./bin/CK_twin_box_proj_max_it_alpha_data.exe ct_gaussian 10 19558 16384 0.3 10000000 1 2
// ./bin/CK_twin_box_proj_max_it_alpha_data.exe ct_gaussian 10 19558 16384 0.5 10000000 1 2
// ./bin/CK_twin_box_proj_max_it_alpha_data.exe ct_gaussian 10 19558 16384 0.75 10000000 1 2
// ./bin/CK_twin_box_proj_max_it_alpha_data.exe ct_gaussian 10 19558 16384 1 10000000 1 2
// ./bin/CK_twin_box_proj_max_it_alpha_data.exe ct_gaussian 10 19558 16384 1.5 10000000 1 2
// ./bin/CK_twin_box_proj_max_it_alpha_data.exe ct_gaussian 10 19558 16384 2 10000000 1 2

int main (int argc, char *argv[]) {

	if(argc != 8 && argc != 9) {
		cout << "Incorrect number of arguments: Corret usage is ";
		cout << "'./bin/CK_twin_box_proj_max_it_alpha_data.exe <data_set> <n_runs> <M> <N> <alpha> <max_it_stop> <step_save>'" << endl;
		exit(1);
	}
	...
	string filename_error = "errors/tomo_stop/" + matrix_type + "/CK_twin_box_proj_alpha_error_" + to_string(M) + "_" + to_string(N) + "_" + str_alpha + "_" + to_string(max_it_stop);
	string filename_gauge = "errors/tomo_stop/" + matrix_type + "/CK_twin_box_proj_alpha_gauge_" + to_string(M) + "_" + to_string(N) + "_" + str_alpha + "_" + to_string(max_it_stop);
