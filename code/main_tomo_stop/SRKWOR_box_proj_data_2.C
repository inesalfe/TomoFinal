...
./bin/SRKWOR_box_proj_data_2.exe ct_gaussian 3 117372 262144 100 2
./bin/SRKWOR_box_proj_data_2.exe ct_gaussian 3 234664 262144 100 2
./bin/SRKWOR_box_proj_data_2.exe ct_gaussian 3 469368 262144 100 2
./bin/SRKWOR_box_proj_data_2.exe ct_gaussian 3 938720 262144 100 2
...
int main (int argc, char *argv[]) {
	...
	if(argc != 6 && argc != 7) {
		...
		cout << "'./bin/SRKWOR_box_proj_data_2.exe <data_set> <n_runs> <M> <N> <max_it_stop>'" << endl;
		exit(1);
	}
	...
	string filename_error = "errors/tomo_stop/" + matrix_type + "/SRKWOR_box_proj_error_2_" + to_string(M) + "_" + to_string(N) + "_" + to_string(max_it_stop);
	string filename_gauge = "errors/tomo_stop/" + matrix_type + "/SRKWOR_box_proj_gauge_2_" + to_string(M) + "_" + to_string(N) + "_" + to_string(max_it_stop);
