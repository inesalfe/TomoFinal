...
// ./bin/SRKAWOR_twin_max_it_data.exe ct_gaussian 10 19558 16384 1 30000000 1 2
// ./bin/SRKAWOR_twin_max_it_data.exe ct_gaussian 10 19558 16384 2 30000000 1 2
// ./bin/SRKAWOR_twin_max_it_data.exe ct_gaussian 10 19558 16384 4 30000000 1 2
// ./bin/SRKAWOR_twin_max_it_data.exe ct_gaussian 10 19558 16384 8 30000000 1 2
// ./bin/SRKAWOR_twin_max_it_data.exe ct_gaussian 10 19558 16384 16 30000000 1 2
// ./bin/SRKAWOR_twin_max_it_data.exe ct_gaussian 10 19558 16384 32 30000000 1 2
// ./bin/SRKAWOR_twin_max_it_data.exe ct_gaussian 10 19558 16384 64 30000000 1 2

int main (int argc, char *argv[]) {

	if(argc != 8 && argc != 9) {
		cout << "Incorrect number of arguments: Corret usage is ";
		cout << "'./bin/SRKAWOR_twin_max_it_data.exe <data_set> <n_runs> <M> <N> <it_per_thread> <max_it_stop> <step_save>'" << endl;
		exit(1);
	}
	...
	string filename_error = "errors/tomo_stop/" + matrix_type + "/SRKAWOR_twin_error_" + to_string(M) + "_" + to_string(N) + "_" + to_string(it_per_thread) + "_" + to_string(max_it_stop);
	string filename_gauge = "errors/tomo_stop/" + matrix_type + "/SRKAWOR_twin_gauge_" + to_string(M) + "_" + to_string(N) + "_" + to_string(it_per_thread) + "_" + to_string(max_it_stop);
