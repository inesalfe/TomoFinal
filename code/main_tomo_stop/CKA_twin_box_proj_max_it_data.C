...
// ./bin/CKA_twin_box_proj_max_it_data.exe ct_gaussian 10 19558 16384 1 10000000 1 2
// ./bin/CKA_twin_box_proj_max_it_data.exe ct_gaussian 10 19558 16384 2 10000000 1 2
// ./bin/CKA_twin_box_proj_max_it_data.exe ct_gaussian 10 19558 16384 4 10000000 1 2
// ./bin/CKA_twin_box_proj_max_it_data.exe ct_gaussian 10 19558 16384 8 10000000 1 2
// ./bin/CKA_twin_box_proj_max_it_data.exe ct_gaussian 10 19558 16384 16 10000000 1 2
// ./bin/CKA_twin_box_proj_max_it_data.exe ct_gaussian 10 19558 16384 32 10000000 1 2
// ./bin/CKA_twin_box_proj_max_it_data.exe ct_gaussian 10 19558 16384 64 10000000 1 2

int main (int argc, char *argv[]) {

	if(argc != 8 && argc != 9) {
		cout << "Incorrect number of arguments: Corret usage is ";
		cout << "'./bin/CKA_twin_box_proj_max_it_data.exe <data_set> <n_runs> <M> <N> <it_per_thread> <max_it_stop> <step_save>'" << endl;
		exit(1);
	}
	...
	for(int run = 0; run < n_runs; run++) {
		...
		while(it < max_it_stop) {
			...
			for (int i = 0; i < it_per_thread; i++) {
				line = M-(it_per_thread*(it-1)+i)%M-1;
	...
	string filename_error = "errors/tomo_stop/" + matrix_type + "/CKA_twin_box_proj_error_" + to_string(M) + "_" + to_string(N) + "_" + to_string(it_per_thread) + "_" + to_string(max_it_stop);
	string filename_gauge = "errors/tomo_stop/" + matrix_type + "/CKA_twin_box_proj_gauge_" + to_string(M) + "_" + to_string(N) + "_" + to_string(it_per_thread) + "_" + to_string(max_it_stop);
