...
// ./bin/RK_box_proj_stop_2.exe ct_gaussian 10 19558 16384 7 2

int main (int argc, char *argv[]) {

	if(argc != 7 && argc != 8) {
		cout << "Incorrect number of arguments: Corret usage is ";
		cout << "'./bin/RK_box_proj_stop_2.exe <data_set> <n_runs> <M> <N> <min_it> <bucket_size>'" << endl;
		exit(1);
	}
	...
	string filename_sol = "outputs/tomo_stop/" + matrix_type + "/RK_box_proj_sol_" + to_string(M) + "_" + to_string(N);
