...
./bin/RK_pos_proj_csr_max_it_data.exe ct 1 3112 484 500000 1000
./bin/RK_pos_proj_csr_max_it_data.exe ct_gaussian 1 4886 1024 500000 1000 1
./bin/RK_pos_proj_csr_max_it_data.exe ct_poisson 1 4886 1024 500000 1000 1

./bin/RK_pos_proj_csr_max_it_data.exe ct 5 3112 484 500000 1000
./bin/RK_pos_proj_csr_max_it_data.exe ct_gaussian 5 4886 1024 500000 1000 1
./bin/RK_pos_proj_csr_max_it_data.exe ct_poisson 5 4886 1024 500000 1000 1
...
int main (int argc, char *argv[]) {
	...
	if(argc != 7 && argc != 8) {
		...
		cout << "'./bin/RK_pos_proj_csr_max_it_data.exe <data_set> <n_runs> <M> <N> <max_it_stop> <step_save>'" << endl;
		exit(1);
	}
	...
	string filename_error = "errors/seq_sparse/" + matrix_type + "/RK_pos_proj_error_" + to_string(M) + "_" + to_string(N) + "_" + to_string(max_it_stop);
	string filename_res = "errors/seq_sparse/" + matrix_type + "/RK_pos_proj_res_" + to_string(M) + "_" + to_string(N) + "_" + to_string(max_it_stop);
