...
./bin/RK_box_proj_csr_max_it_data.exe ct 1 3112 484 500000 1000
./bin/RK_box_proj_csr_max_it_data.exe ct_gaussian 1 4886 1024 500000 1000 1
./bin/RK_box_proj_csr_max_it_data.exe ct_poisson 1 4886 1024 500000 1000 1

./bin/RK_box_proj_csr_max_it_data.exe ct 5 3112 484 500000 1000
./bin/RK_box_proj_csr_max_it_data.exe ct_gaussian 5 4886 1024 500000 1000 1
./bin/RK_box_proj_csr_max_it_data.exe ct_poisson 5 4886 1024 500000 1000 1
...
int main (int argc, char *argv[]) {
	...
	if(argc != 8 && argc != 9) {
		...
		cout << "'./bin/RK_box_proj_csr_max_it_alpha_data.exe <data_set> <n_runs> <M> <N> <alpha> <max_it_stop> <step_save>'" << endl;
		exit(1);
	}
	...
	string filename_error = "errors/seq_sparse/" + matrix_type + "/RK_alpha_box_proj_error_" + to_string(M) + "_" + to_string(N) + "_" + str_alpha + "_" + to_string(max_it_stop);
	string filename_res = "errors/seq_sparse/" + matrix_type + "/RK_alpha_box_proj_res_" + to_string(M) + "_" + to_string(N) + "_" + str_alpha + "_" + to_string(max_it_stop);
