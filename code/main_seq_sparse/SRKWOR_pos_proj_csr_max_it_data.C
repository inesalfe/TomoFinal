...
./bin/SRKWOR_pos_proj_csr_max_it_data.exe ct 1 3112 484 500000 1000
./bin/SRKWOR_pos_proj_csr_max_it_data.exe ct_gaussian 1 4886 1024 500000 1000 1
./bin/SRKWOR_pos_proj_csr_max_it_data.exe ct_poisson 1 4886 1024 500000 1000 1

./bin/SRKWOR_pos_proj_csr_max_it_data.exe ct 5 3112 484 500000 1000
./bin/SRKWOR_pos_proj_csr_max_it_data.exe ct_gaussian 5 4886 1024 500000 1000 1
./bin/SRKWOR_pos_proj_csr_max_it_data.exe ct_poisson 5 4886 1024 500000 1000 1
...
int main (int argc, char *argv[]) {
	...
	if(argc != 7 && argc != 8) {
		...
		cout << "'./bin/SRKWOR_pos_proj_csr_max_it_data.exe <data_set> <n_runs> <M> <N> <max_it_stop> <step_save>'" << endl;
		exit(1);
	}
