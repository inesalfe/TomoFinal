...
if (data_set == "ct"):
	...
	output_foler = "/"
	filename_error = error_folder + "SRKWOR_pos_proj_error_" + str(M) + "_" + str(N) + "_" + str(max_it) + ".txt"
	filename_res = error_folder + "SRKWOR_pos_proj_res_" + str(M) + "_" + str(N) + "_" + str(max_it) + ".txt"
	filename_fig = "SRKWOR_pos_proj_" + str(M) + "_" + str(N) + "_" + str(max_it)
elif (data_set == "ct_gaussian"):
	seed = int(sys.argv[5])
	error_folder = "errors/seq_sparse/ct_gaussian/"
	output_foler = "_gaussian/"
	filename_error = error_folder + "SRKWOR_pos_proj_error_" + str(M) + "_" + str(N) + "_" + str(max_it) + "_" + str(seed) + ".txt"
	filename_res = error_folder + "SRKWOR_pos_proj_res_" + str(M) + "_" + str(N) + "_" + str(max_it) + "_" + str(seed) + ".txt"
	filename_fig = "SRKWOR_pos_proj_" + str(M) + "_" + str(N) + "_" + str(max_it) + "_" + str(seed)
