...
if (data_set == "ct"):
	...
	output_foler = "/"
	filename_error = error_folder + "CK_error_" + str(M) + "_" + str(N) + "_" + str(max_it) + ".txt"
	filename_res = error_folder + "CK_res_" + str(M) + "_" + str(N) + "_" + str(max_it) + ".txt"
	filename_fig = "CK_" + str(M) + "_" + str(N) + "_" + str(max_it)
