...
if (data_set == "ct"):
	...
	filename_fig_error = "CKAB_error_" + str(M) + "_" + str(N) + "_" + str(block_size) + "_" + str(max_it)
	filename_fig_error_1 = "CKAB_error_" + str(M) + "_" + str(N) + "_" + str(block_size) + "_" + str(max_it)
	filename_fig_error_inf = "CKAB_error_" + str(M) + "_" + str(N) + "_" + str(block_size) + "_" + str(max_it)
	filename_fig_res = "CKAB_res_" + str(M) + "_" + str(N) + "_" + str(block_size) + "_" + str(max_it)
	...
	filename_fig_error = "CKAB_error_" + str(M) + "_" + str(N) + "_" + str(block_size) + "_" + str(max_it) + "_" + str(seed)
	filename_fig_error_1 = "CKAB_error_" + str(M) + "_" + str(N) + "_" + str(block_size) + "_" + str(max_it) + "_" + str(seed)
	filename_fig_error_inf = "CKAB_error_" + str(M) + "_" + str(N) + "_" + str(block_size) + "_" + str(max_it) + "_" + str(seed)
	filename_fig_res = "CKAB_res_" + str(M) + "_" + str(N) + "_" + str(block_size) + "_" + str(max_it) + "_" + str(seed)
