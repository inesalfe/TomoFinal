...
# python3 plots/omp_sparse/RKA_alpha.py ct_gaussian 19558 16384 30000000 4 2
...
# python3 plots/omp_sparse/RKA_alpha.py ct_gaussian 19558 16384 30000000 2 2
...
# python3 plots/omp_sparse/RKA_alpha.py ct_gaussian 19558 16384 30000000 8 2
...
if (data_set == "ct"):
	...
	output_foler = "/"
	filename_error_1 = error_folder + "RKA_alpha_error_" + str(M) + "_" + str(N) + "_" + str(threads) + "_" + str(alpha_1) + "_" + str(max_it) + ".txt"
	filename_res_1 = error_folder + "RKA_alpha_res_" + str(M) + "_" + str(N) + "_" + str(threads) + "_" + str(alpha_1) + "_" + str(max_it) + ".txt"
	filename_error_2 = error_folder + "RKA_alpha_error_" + str(M) + "_" + str(N) + "_" + str(threads) + "_" + str(alpha_2) + "_" + str(max_it) + ".txt"
	filename_res_2 = error_folder + "RKA_alpha_res_" + str(M) + "_" + str(N) + "_" + str(threads) + "_" + str(alpha_2) + "_" + str(max_it) + ".txt"
	filename_error_3 = error_folder + "RKA_alpha_error_" + str(M) + "_" + str(N) + "_" + str(threads) + "_" + str(alpha_3) + "_" + str(max_it) + ".txt"
	filename_res_3 = error_folder + "RKA_alpha_res_" + str(M) + "_" + str(N) + "_" + str(threads) + "_" + str(alpha_3) + "_" + str(max_it) + ".txt"
	filename_error_4 = error_folder + "RKA_alpha_error_" + str(M) + "_" + str(N) + "_" + str(threads) + "_" + str(alpha_4) + "_" + str(max_it) + ".txt"
	filename_res_4 = error_folder + "RKA_alpha_res_" + str(M) + "_" + str(N) + "_" + str(threads) + "_" + str(alpha_4) + "_" + str(max_it) + ".txt"
	filename_error_5 = error_folder + "RKA_alpha_error_" + str(M) + "_" + str(N) + "_" + str(threads) + "_" + str(alpha_5) + "_" + str(max_it) + ".txt"
	filename_res_5 = error_folder + "RKA_alpha_res_" + str(M) + "_" + str(N) + "_" + str(threads) + "_" + str(alpha_5) + "_" + str(max_it) + ".txt"
	filename_error_6= error_folder + "RKA_alpha_error_" + str(M) + "_" + str(N) + "_" + str(threads) + "_" + str(alpha_6) + "_" + str(max_it) + ".txt"
	filename_res_6= error_folder + "RKA_alpha_res_" + str(M) + "_" + str(N) + "_" + str(threads) + "_" + str(alpha_6) + "_" + str(max_it) + ".txt"
	filename_error_7= error_folder + "RKA_alpha_error_" + str(M) + "_" + str(N) + "_" + str(threads) + "_" + str(alpha_7) + "_" + str(max_it) + ".txt"
	filename_res_7= error_folder + "RKA_alpha_res_" + str(M) + "_" + str(N) + "_" + str(threads) + "_" + str(alpha_7) + "_" + str(max_it) + ".txt"
	filename_fig_error = "RKA_alpha_error_" + str(M) + "_" + str(N) + "_" + str(max_it) + "_" + str(threads)
	filename_fig_res = "RKA_alpha_res_" + str(M) + "_" + str(N) + "_" + str(max_it) + "_" + str(threads)
elif (data_set == "ct_gaussian"):
	seed = int(sys.argv[6])
	error_folder = "errors/omp_sparse/ct_gaussian/"
	output_foler = "_gaussian/"
	filename_error_1 = error_folder + "RKA_alpha_error_" + str(M) + "_" + str(N) + "_" + str(threads) + "_" + str(alpha_1) + "_" + str(max_it) + "_" + str(seed) + ".txt"
	filename_res_1 = error_folder + "RKA_alpha_res_" + str(M) + "_" + str(N) + "_" + str(threads) + "_" + str(alpha_1) + "_" + str(max_it) + "_" + str(seed) + ".txt"
	filename_error_2 = error_folder + "RKA_alpha_error_" + str(M) + "_" + str(N) + "_" + str(threads) + "_" + str(alpha_2) + "_" + str(max_it) + "_" + str(seed) + ".txt"
	filename_res_2 = error_folder + "RKA_alpha_res_" + str(M) + "_" + str(N) + "_" + str(threads) + "_" + str(alpha_2) + "_" + str(max_it) + "_" + str(seed) + ".txt"
	filename_error_3 = error_folder + "RKA_alpha_error_" + str(M) + "_" + str(N) + "_" + str(threads) + "_" + str(alpha_3) + "_" + str(max_it) + "_" + str(seed) + ".txt"
	filename_res_3 = error_folder + "RKA_alpha_res_" + str(M) + "_" + str(N) + "_" + str(threads) + "_" + str(alpha_3) + "_" + str(max_it) + "_" + str(seed) + ".txt"
	filename_error_4 = error_folder + "RKA_alpha_error_" + str(M) + "_" + str(N) + "_" + str(threads) + "_" + str(alpha_4) + "_" + str(max_it) + "_" + str(seed) + ".txt"
	filename_res_4 = error_folder + "RKA_alpha_res_" + str(M) + "_" + str(N) + "_" + str(threads) + "_" + str(alpha_4) + "_" + str(max_it) + "_" + str(seed) + ".txt"
	filename_error_5 = error_folder + "RKA_alpha_error_" + str(M) + "_" + str(N) + "_" + str(threads) + "_" + str(alpha_5) + "_" + str(max_it) + "_" + str(seed) + ".txt"
	filename_res_5 = error_folder + "RKA_alpha_res_" + str(M) + "_" + str(N) + "_" + str(threads) + "_" + str(alpha_5) + "_" + str(max_it) + "_" + str(seed) + ".txt"
	filename_error_6= error_folder + "RKA_alpha_error_" + str(M) + "_" + str(N) + "_" + str(threads) + "_" + str(alpha_6) + "_" + str(max_it) + "_" + str(seed) + ".txt"
	filename_res_6= error_folder + "RKA_alpha_res_" + str(M) + "_" + str(N) + "_" + str(threads) + "_" + str(alpha_6) + "_" + str(max_it) + "_" + str(seed) + ".txt"
	filename_error_7= error_folder + "RKA_alpha_error_" + str(M) + "_" + str(N) + "_" + str(threads) + "_" + str(alpha_7) + "_" + str(max_it) + "_" + str(seed) + ".txt"
	filename_res_7= error_folder + "RKA_alpha_res_" + str(M) + "_" + str(N) + "_" + str(threads) + "_" + str(alpha_7) + "_" + str(max_it) + "_" + str(seed) + ".txt"
	filename_fig_error = "RKA_alpha_error_" + str(M) + "_" + str(N) + "_" + str(max_it) + "_" + str(threads) + "_" + str(seed)
	filename_fig_res = "RKA_alpha_res_" + str(M) + "_" + str(N) + "_" + str(max_it) + "_" + str(threads) + "_" + str(seed)
