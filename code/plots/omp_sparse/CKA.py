...
if (data_set == "ct"):
	...
	filename_fig_error = "CKA_error_" + str(M) + "_" + str(N) + "_" + str(max_it)
	filename_fig_res = "CKA_res_" + str(M) + "_" + str(N) + "_" + str(max_it)
	...
	filename_fig_error = "CKA_error_" + str(M) + "_" + str(N) + "_" + str(max_it) + "_" + str(seed)
	filename_fig_res = "CKA_res_" + str(M) + "_" + str(N) + "_" + str(max_it) + "_" + str(seed)
