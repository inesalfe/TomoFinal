...
# python3 plots/tomo_stop/CKA_twin.py ct_gaussian 19558 16384 30000000 2
...
if (data_set == "ct"):
	output_folder = "/"
	filename_error_1 = "errors/omp_sparse/ct/CKA_error_" + str(M) + "_" + str(N) + "_1_" + str(max_it) + ".txt"
	filename_error_2 = "errors/omp_sparse/ct/CKA_error_" + str(M) + "_" + str(N) + "_2_" + str(max_it) + ".txt"
	filename_error_3 = "errors/omp_sparse/ct/CKA_error_" + str(M) + "_" + str(N) + "_4_" + str(max_it) + ".txt"
	filename_error_4 = "errors/omp_sparse/ct/CKA_error_" + str(M) + "_" + str(N) + "_8_" + str(max_it) + ".txt"
	filename_error_5 = "errors/omp_sparse/ct/CKA_error_" + str(M) + "_" + str(N) + "_16_" + str(max_it) + ".txt"
	filename_error_6 = "errors/omp_sparse/ct/CKA_error_" + str(M) + "_" + str(N) + "_32_" + str(max_it) + ".txt"
	filename_error_7 = "errors/omp_sparse/ct/CKA_error_" + str(M) + "_" + str(N) + "_64_" + str(max_it) + ".txt"
	filename_error_twin_1 = "errors/tomo_stop/ct/CKA_twin_error_" + str(M) + "_" + str(N) + "_1_" + str(max_it) + ".txt"
	filename_error_twin_2 = "errors/tomo_stop/ct/CKA_twin_error_" + str(M) + "_" + str(N) + "_2_" + str(max_it) + ".txt"
	filename_error_twin_3 = "errors/tomo_stop/ct/CKA_twin_error_" + str(M) + "_" + str(N) + "_4_" + str(max_it) + ".txt"
	filename_error_twin_4 = "errors/tomo_stop/ct/CKA_twin_error_" + str(M) + "_" + str(N) + "_8_" + str(max_it) + ".txt"
	filename_error_twin_5 = "errors/tomo_stop/ct/CKA_twin_error_" + str(M) + "_" + str(N) + "_16_" + str(max_it) + ".txt"
	filename_error_twin_6 = "errors/tomo_stop/ct/CKA_twin_error_" + str(M) + "_" + str(N) + "_32_" + str(max_it) + ".txt"
	filename_error_twin_7 = "errors/tomo_stop/ct/CKA_twin_error_" + str(M) + "_" + str(N) + "_64_" + str(max_it) + ".txt"
	filename_gauge_1 = "errors/tomo_stop/ct/CKA_twin_gauge_" + str(M) + "_" + str(N) + "_1_" + str(max_it) + ".txt"
	filename_gauge_2 = "errors/tomo_stop/ct/CKA_twin_gauge_" + str(M) + "_" + str(N) + "_2_" + str(max_it) + ".txt"
	filename_gauge_3 = "errors/tomo_stop/ct/CKA_twin_gauge_" + str(M) + "_" + str(N) + "_4_" + str(max_it) + ".txt"
	filename_gauge_4 = "errors/tomo_stop/ct/CKA_twin_gauge_" + str(M) + "_" + str(N) + "_8_" + str(max_it) + ".txt"
	filename_gauge_5 = "errors/tomo_stop/ct/CKA_twin_gauge_" + str(M) + "_" + str(N) + "_16_" + str(max_it) + ".txt"
	filename_gauge_6 = "errors/tomo_stop/ct/CKA_twin_gauge_" + str(M) + "_" + str(N) + "_32_" + str(max_it) + ".txt"
	filename_gauge_7 = "errors/tomo_stop/ct/CKA_twin_gauge_" + str(M) + "_" + str(N) + "_64_" + str(max_it) + ".txt"
	filename_fig_1 = "CKA_twin_" + str(M) + "_" + str(N) + "_1_" + str(max_it)
	filename_fig_2 = "CKA_twin_" + str(M) + "_" + str(N) + "_2_" + str(max_it)
	filename_fig_3 = "CKA_twin_" + str(M) + "_" + str(N) + "_4_" + str(max_it)
	filename_fig_4 = "CKA_twin_" + str(M) + "_" + str(N) + "_8_" + str(max_it)
	filename_fig_5 = "CKA_twin_" + str(M) + "_" + str(N) + "_16_" + str(max_it)
	filename_fig_6 = "CKA_twin_" + str(M) + "_" + str(N) + "_32_" + str(max_it)
	filename_fig_7 = "CKA_twin_" + str(M) + "_" + str(N) + "_64_" + str(max_it)
elif (data_set == "ct_gaussian"):
	seed = int(sys.argv[5])
	output_folder = "_gaussian/"
	filename_error_1 = "errors/omp_sparse/ct_gaussian/CKA_error_" + str(M) + "_" + str(N) + "_1_" + str(max_it) + "_" + str(seed) + ".txt"
	filename_error_2 = "errors/omp_sparse/ct_gaussian/CKA_error_" + str(M) + "_" + str(N) + "_2_" + str(max_it) + "_" + str(seed) + ".txt"
	filename_error_3 = "errors/omp_sparse/ct_gaussian/CKA_error_" + str(M) + "_" + str(N) + "_4_" + str(max_it) + "_" + str(seed) + ".txt"
	filename_error_4 = "errors/omp_sparse/ct_gaussian/CKA_error_" + str(M) + "_" + str(N) + "_8_" + str(max_it) + "_" + str(seed) + ".txt"
	filename_error_5 = "errors/omp_sparse/ct_gaussian/CKA_error_" + str(M) + "_" + str(N) + "_16_" + str(max_it) + "_" + str(seed) + ".txt"
	filename_error_6 = "errors/omp_sparse/ct_gaussian/CKA_error_" + str(M) + "_" + str(N) + "_32_" + str(max_it) + "_" + str(seed) + ".txt"
	filename_error_7 = "errors/omp_sparse/ct_gaussian/CKA_error_" + str(M) + "_" + str(N) + "_64_" + str(max_it) + "_" + str(seed) + ".txt"
	filename_error_twin_1 = "errors/tomo_stop/ct_gaussian/CKA_twin_error_" + str(M) + "_" + str(N) + "_1_" + str(max_it) + "_" + str(seed) + ".txt"
	filename_error_twin_2 = "errors/tomo_stop/ct_gaussian/CKA_twin_error_" + str(M) + "_" + str(N) + "_2_" + str(max_it) + "_" + str(seed) + ".txt"
	filename_error_twin_3 = "errors/tomo_stop/ct_gaussian/CKA_twin_error_" + str(M) + "_" + str(N) + "_4_" + str(max_it) + "_" + str(seed) + ".txt"
	filename_error_twin_4 = "errors/tomo_stop/ct_gaussian/CKA_twin_error_" + str(M) + "_" + str(N) + "_8_" + str(max_it) + "_" + str(seed) + ".txt"
	filename_error_twin_5 = "errors/tomo_stop/ct_gaussian/CKA_twin_error_" + str(M) + "_" + str(N) + "_16_" + str(max_it) + "_" + str(seed) + ".txt"
	filename_error_twin_6 = "errors/tomo_stop/ct_gaussian/CKA_twin_error_" + str(M) + "_" + str(N) + "_32_" + str(max_it) + "_" + str(seed) + ".txt"
	filename_error_twin_7 = "errors/tomo_stop/ct_gaussian/CKA_twin_error_" + str(M) + "_" + str(N) + "_64_" + str(max_it) + "_" + str(seed) + ".txt"
	filename_gauge_1 = "errors/tomo_stop/ct_gaussian/CKA_twin_gauge_" + str(M) + "_" + str(N) + "_1_" + str(max_it) + "_" + str(seed) + ".txt"
	filename_gauge_2 = "errors/tomo_stop/ct_gaussian/CKA_twin_gauge_" + str(M) + "_" + str(N) + "_2_" + str(max_it) + "_" + str(seed) + ".txt"
	filename_gauge_3 = "errors/tomo_stop/ct_gaussian/CKA_twin_gauge_" + str(M) + "_" + str(N) + "_4_" + str(max_it) + "_" + str(seed) + ".txt"
	filename_gauge_4 = "errors/tomo_stop/ct_gaussian/CKA_twin_gauge_" + str(M) + "_" + str(N) + "_8_" + str(max_it) + "_" + str(seed) + ".txt"
	filename_gauge_5 = "errors/tomo_stop/ct_gaussian/CKA_twin_gauge_" + str(M) + "_" + str(N) + "_16_" + str(max_it) + "_" + str(seed) + ".txt"
	filename_gauge_6 = "errors/tomo_stop/ct_gaussian/CKA_twin_gauge_" + str(M) + "_" + str(N) + "_32_" + str(max_it) + "_" + str(seed) + ".txt"
	filename_gauge_7 = "errors/tomo_stop/ct_gaussian/CKA_twin_gauge_" + str(M) + "_" + str(N) + "_64_" + str(max_it) + "_" + str(seed) + ".txt"
	filename_fig_1 = "CKA_twin_" + str(M) + "_" + str(N) + "_1_" + str(max_it) + "_" + str(seed)
	filename_fig_2 = "CKA_twin_" + str(M) + "_" + str(N) + "_2_" + str(max_it) + "_" + str(seed)
	filename_fig_3 = "CKA_twin_" + str(M) + "_" + str(N) + "_4_" + str(max_it) + "_" + str(seed)
	filename_fig_4 = "CKA_twin_" + str(M) + "_" + str(N) + "_8_" + str(max_it) + "_" + str(seed)
	filename_fig_5 = "CKA_twin_" + str(M) + "_" + str(N) + "_16_" + str(max_it) + "_" + str(seed)
	filename_fig_6 = "CKA_twin_" + str(M) + "_" + str(N) + "_32_" + str(max_it) + "_" + str(seed)
	filename_fig_7 = "CKA_twin_" + str(M) + "_" + str(N) + "_64_" + str(max_it) + "_" + str(seed)
elif (data_set == "ct_poisson"):
	seed = int(sys.argv[5])
	output_folder = "_poisson/"
	filename_error_1 = "errors/omp_sparse/ct_poisson/CKA_error_" + str(M) + "_" + str(N) + "_1_" + str(max_it) + "_" + str(seed) + ".txt"
	filename_error_2 = "errors/omp_sparse/ct_poisson/CKA_error_" + str(M) + "_" + str(N) + "_2_" + str(max_it) + "_" + str(seed) + ".txt"
	filename_error_3 = "errors/omp_sparse/ct_poisson/CKA_error_" + str(M) + "_" + str(N) + "_4_" + str(max_it) + "_" + str(seed) + ".txt"
	filename_error_4 = "errors/omp_sparse/ct_poisson/CKA_error_" + str(M) + "_" + str(N) + "_8_" + str(max_it) + "_" + str(seed) + ".txt"
	filename_error_5 = "errors/omp_sparse/ct_poisson/CKA_error_" + str(M) + "_" + str(N) + "_16_" + str(max_it) + "_" + str(seed) + ".txt"
	filename_error_6 = "errors/omp_sparse/ct_poisson/CKA_error_" + str(M) + "_" + str(N) + "_32_" + str(max_it) + "_" + str(seed) + ".txt"
	filename_error_7 = "errors/omp_sparse/ct_poisson/CKA_error_" + str(M) + "_" + str(N) + "_64_" + str(max_it) + "_" + str(seed) + ".txt"
	filename_error_twin_1 = "errors/tomo_stop/ct_poisson/CKA_twin_error_" + str(M) + "_" + str(N) + "_1_" + str(max_it) + "_" + str(seed) + ".txt"
	filename_error_twin_2 = "errors/tomo_stop/ct_poisson/CKA_twin_error_" + str(M) + "_" + str(N) + "_2_" + str(max_it) + "_" + str(seed) + ".txt"
	filename_error_twin_3 = "errors/tomo_stop/ct_poisson/CKA_twin_error_" + str(M) + "_" + str(N) + "_4_" + str(max_it) + "_" + str(seed) + ".txt"
	filename_error_twin_4 = "errors/tomo_stop/ct_poisson/CKA_twin_error_" + str(M) + "_" + str(N) + "_8_" + str(max_it) + "_" + str(seed) + ".txt"
	filename_error_twin_5 = "errors/tomo_stop/ct_poisson/CKA_twin_error_" + str(M) + "_" + str(N) + "_16_" + str(max_it) + "_" + str(seed) + ".txt"
	filename_error_twin_6 = "errors/tomo_stop/ct_poisson/CKA_twin_error_" + str(M) + "_" + str(N) + "_32_" + str(max_it) + "_" + str(seed) + ".txt"
	filename_error_twin_7 = "errors/tomo_stop/ct_poisson/CKA_twin_error_" + str(M) + "_" + str(N) + "_64_" + str(max_it) + "_" + str(seed) + ".txt"
	filename_gauge_1 = "errors/tomo_stop/ct_poisson/CKA_twin_gauge_" + str(M) + "_" + str(N) + "_1_" + str(max_it) + "_" + str(seed) + ".txt"
	filename_gauge_2 = "errors/tomo_stop/ct_poisson/CKA_twin_gauge_" + str(M) + "_" + str(N) + "_2_" + str(max_it) + "_" + str(seed) + ".txt"
	filename_gauge_3 = "errors/tomo_stop/ct_poisson/CKA_twin_gauge_" + str(M) + "_" + str(N) + "_4_" + str(max_it) + "_" + str(seed) + ".txt"
	filename_gauge_4 = "errors/tomo_stop/ct_poisson/CKA_twin_gauge_" + str(M) + "_" + str(N) + "_8_" + str(max_it) + "_" + str(seed) + ".txt"
	filename_gauge_5 = "errors/tomo_stop/ct_poisson/CKA_twin_gauge_" + str(M) + "_" + str(N) + "_16_" + str(max_it) + "_" + str(seed) + ".txt"
	filename_gauge_6 = "errors/tomo_stop/ct_poisson/CKA_twin_gauge_" + str(M) + "_" + str(N) + "_32_" + str(max_it) + "_" + str(seed) + ".txt"
	filename_gauge_7 = "errors/tomo_stop/ct_poisson/CKA_twin_gauge_" + str(M) + "_" + str(N) + "_64_" + str(max_it) + "_" + str(seed) + ".txt"
	filename_fig_1 = "CKA_twin_" + str(M) + "_" + str(N) + "_1_" + str(max_it) + "_" + str(seed)
	filename_fig_2 = "CKA_twin_" + str(M) + "_" + str(N) + "_2_" + str(max_it) + "_" + str(seed)
	filename_fig_3 = "CKA_twin_" + str(M) + "_" + str(N) + "_4_" + str(max_it) + "_" + str(seed)
	filename_fig_4 = "CKA_twin_" + str(M) + "_" + str(N) + "_8_" + str(max_it) + "_" + str(seed)
