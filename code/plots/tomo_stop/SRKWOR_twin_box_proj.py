...
# python3 plots/tomo_stop/SRKWOR_twin_box_proj.py ct_gaussian 19558 16384 10000000 2
...
if (data_set == "ct"):
	output_folder = "/"
	filename_error = "errors/seq_sparse/ct/SRKWOR_box_proj_error_" + str(M) + "_" + str(N) + "_" + str(max_it) + ".txt"
	filename_error_twin = "errors/tomo_stop/ct/SRKWOR_twin_box_proj_error_" + str(M) + "_" + str(N) + "_" + str(max_it) + ".txt"
	filename_gauge = "errors/tomo_stop/ct/SRKWOR_twin_box_proj_gauge_" + str(M) + "_" + str(N) + "_" + str(max_it) + ".txt"
	filename_fig = "SRKWOR_twin_box_proj_" + str(M) + "_" + str(N) + "_" + str(max_it)
elif (data_set == "ct_gaussian"):
	seed = int(sys.argv[5])
	output_folder = "_gaussian/"
	filename_error = "errors/seq_sparse/ct_gaussian/SRKWOR_box_proj_error_" + str(M) + "_" + str(N) + "_" + str(max_it) + "_" + str(seed) + ".txt"
	filename_error_twin = "errors/tomo_stop/ct_gaussian/SRKWOR_twin_box_proj_error_" + str(M) + "_" + str(N) + "_" + str(max_it) + "_" + str(seed) + ".txt"
	filename_gauge = "errors/tomo_stop/ct_gaussian/SRKWOR_twin_box_proj_gauge_" + str(M) + "_" + str(N) + "_" + str(max_it) + "_" + str(seed) + ".txt"
	filename_fig = "SRKWOR_twin_box_proj_" + str(M) + "_" + str(N) + "_" + str(max_it) + "_" + str(seed)
