...
# python3 plots/tomo_stop/RK_twin.py ct_gaussian 19558 16384 30000000 2
...
if (data_set == "ct"):
	output_folder = "/"
	filename_error = "errors/seq_sparse/ct/RK_error_" + str(M) + "_" + str(N) + "_" + str(max_it) + ".txt"
	filename_error_twin = "errors/tomo_stop/ct/RK_twin_error_" + str(M) + "_" + str(N) + "_" + str(max_it) + ".txt"
	filename_gauge = "errors/tomo_stop/ct/RK_twin_gauge_" + str(M) + "_" + str(N) + "_" + str(max_it) + ".txt"
	filename_fig = "RK_twin_" + str(M) + "_" + str(N) + "_" + str(max_it)
elif (data_set == "ct_gaussian"):
	seed = int(sys.argv[5])
	output_folder = "_gaussian/"
	filename_error = "errors/seq_sparse/ct_gaussian/RK_error_" + str(M) + "_" + str(N) + "_" + str(max_it) + "_" + str(seed) + ".txt"
	filename_error_twin = "errors/tomo_stop/ct_gaussian/RK_twin_error_" + str(M) + "_" + str(N) + "_" + str(max_it) + "_" + str(seed) + ".txt"
	filename_gauge = "errors/tomo_stop/ct_gaussian/RK_twin_gauge_" + str(M) + "_" + str(N) + "_" + str(max_it) + "_" + str(seed) + ".txt"
	filename_fig = "RK_twin_" + str(M) + "_" + str(N) + "_" + str(max_it) + "_" + str(seed)
