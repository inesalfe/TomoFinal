...
int main (int argc, char *argv[]) {
	...
	if(argc != 7 && argc != 8) {
		...
		cout << "'./bin/SRKAWOR_csr_max_it_dist_conflict.exe <data_set> <n_runs> <M> <N> <it_per_thread> <max_it_stop>'" << endl;
		exit(1);
	}
	...
	cout << "SRKAWOR-dist " << it_per_thread << " " << M << " " << N << " " << duration << " " << max_it_stop << " ";
